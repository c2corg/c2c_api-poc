...
class TestSitemapXml(BaseTestRest):
    ...
    def test_get_waypoint_sitemap(self):
        ...
        self.assertEqual(
            url[0].text, "{}/waypoints/{}/fr/dent-de-crolles".format(self.ui_url, self.waypoint1.document_id)
        )
    ...
    def test_get_route_sitemap(self):
        ...
        self.assertEqual(url[1].tag, "{}lastmod".format(self.schema_url))
        self.assertEqual(
            url[0].text, "{}/routes/{}/fr/mont-blanc-mont-blanc-du-ciel".format(self.ui_url, self.route.document_id)
        )
