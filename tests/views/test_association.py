...
class TestAssociationRest(BaseTestRest):
    ...
    def test_add_association_invalid(self):
        ...
        self.assertEqual(errors[0].get("description"), "invalid association type")
    ...
    def test_add_association_redirected_document(self):
        ...
        self.assertEqual(errors[0].get("description"), "child document does not exist or is redirected")
    ...
    def test_add_association_invalid_ids(self):
        ...
        self.assertEqual(errors[0].get("description"), "parent document does not exist or is redirected")

        self.assertEqual(errors[1].get("name"), "child_document_id")
        self.assertEqual(errors[1].get("description"), "child document does not exist or is redirected")
