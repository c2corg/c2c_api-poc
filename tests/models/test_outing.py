...
class TestOuting(BaseTestCase):
    def test_to_archive(self):
        outing = Outing(
            ...
            elevation_max=1200,
            locales=[
                OutingLocale(id=2, lang="en", title="A", description="abc", route_description="..."),
                OutingLocale(id=3, lang="fr", title="B", description="bcd", route_description="..."),
            ],
        )
        ...
        self.assertEqual(outing_archive.activities, outing.activities)
        ...
        self.assertEqual(locale_archive.route_description, locale.route_description)
