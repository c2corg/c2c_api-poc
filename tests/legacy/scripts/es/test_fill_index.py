    ...
    def test_fill_index(self):
        ...
        self.session.add(
            Waypoint(
                ...
                locales=[
                    WaypointLocale(
                        lang="fr", title="Mont Granier", description="...", summary="Le Mont [b]Granier[/b]"
                    ),
        ...
        self.session.add(
            Route(
                ...
                locales=[
                    RouteLocale(
                        lang="en", title="Face N", description="...", gear="paraglider", title_prefix="Mont Blanc"
                    )
                ],
            )
        )
        ...
        self.session.add(
            Outing(
                ...
                locales=[OutingLocale(lang="en", title="Mont Blanc : Face N !", description="...", weather="sunny")],
            )
        )
        self.session.add(
            Article(
                ...
                geometry=DocumentGeometry(geom="SRID=3857;POINT(635956 5723604)"),
                locales=[
                    DocumentLocale(lang="en", title="Lac d'Annecy", description="...", summary=""),
                    DocumentLocale(lang="fr", title="Lac d'Annecy", description="...", summary=""),
                ],
            )
        )
        self.session.flush()
        ...
        self.session.add(
            Book(
                ...
                publication_date="",
                locales=[
                    DocumentLocale(lang="fr", title="Escalades au Thaurac", description="...", summary=""),
                    DocumentLocale(lang="en", title="Escalades au Thaurac", description="...", summary=""),
                ],
            )
        )
        self.session.flush()
        ...
        self.session.add(
            Xreport(
                ...
                locales=[
                    XreportLocale(
                        lang="en", title="Death in the mountains", description="...", place="some place description"
                    )
                ],
            )
        )
