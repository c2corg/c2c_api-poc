...
from c2corg_api.views.validation import validate_associations_in, parse_datetime
...
class TestValidation(BaseTestCase):
    ...
    def test_validate_associations_invalid_document_id(self):
        ...
        self.assertEqual(error["description"], 'document "-99999" does not exist or is redirected')
    ...
    def test_validate_associations_invalid_document_type(self):
        ...
        self.assertEqual(error["description"], 'document "' + str(self.waypoint1.document_id) + '" is not of type "r"')
