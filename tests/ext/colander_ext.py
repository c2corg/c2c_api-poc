from c2corg_api.ext.colander_ext import from_wkb, wkbelement_from_geojson, geojson_from_wkbelement
...
class TestGeometry(BaseTestCase):
    ...
    def test_serialize_wkb(self):
        ...
        self.assertEqual({"type": "Point", "coordinates": [1.0, 2.0]}, json.loads(geom_schema.serialize({}, wkb)))
    ...
    def test_serialize_4d_wkb(self):
        ...
        wkb = geomet_wkb.dumps({"type": "Point", "coordinates": [1.0, 2.0, 3.0, 4.0]}, big_endian=False)
        self.assertEqual(
            {"type": "Point", "coordinates": [1.0, 2.0, 3.0, 4.0]}, json.loads(geom_schema.serialize({}, from_wkb(wkb)))
        )
    ...
    def test_deserialize_4d(self):
        ...
        wkb = geom_schema.deserialize({}, '{"type": "Point", "coordinates": [1.0, 2.0, 3.0, 4.0]}')
        self.assertEqual(expected_wkb.desc, wkb.desc)
    ...
    def test_serialize_invalid_wrong_type(self):
        ...
        self.assertRaises(Invalid, geom_schema.deserialize, {}, '{"type": "InvalidType", "coordinates": [1.0, 2.0]}')
    ...
    def test_save_and_load(self):
        ...
        geom = wkbelement_from_geojson('{"type": "Point", "coordinates": [1.0, 2.0]}', 3857)
    ...
    def test_save_and_load_3d(self):
        ...
        geom = wkbelement_from_geojson('{"type": "Point", "coordinates": [1.0, 2.0, 3.0]}', 3857)
        ...
        geom_geojson = json.loads(geom_str)
        self.assertCoodinateEquals([1.0, 2.0, 3.0], geom_geojson["coordinates"])
    ...
    def test_save_and_load_4d(self):
        ...
        geom = wkbelement_from_geojson('{"type": "Point", "coordinates": [1.0, 2.0, 3.0, 4.0]}', 3857)
        geometry = DocumentGeometry(document_id=fake_doc.document_id, geom_detail=geom)
        self.session.add(geometry)
        self.session.flush()
        self.session.expire(geometry)
        ...
        geom_geojson = json.loads(geom_str)
        self.assertCoodinateEquals([1.0, 2.0, 3.0, 4.0], geom_geojson["coordinates"])
